        ...
        $(".outer-section").each(function(i) {
            ...
            if (wrapper.find(".split-columns").length > 0) {
                ...
                if (wrapper.find("li").length > 1) {
                    ...
                    html += perch + '      <div><a href="" title="" target="_blank"><img src="images/qd_s' + counter + '.png" alt="" /></a></div>' + '\r\n'
                }
                html += perch + '    </div>' + '\r\n'
        ...
        $(".outer-section").each(function(i) {
            ...
            if (wrapper.find(".split-columns").length > 0) {
                ...
                if (wrapper.find("li").length > 1) {
                    ...
                    html += perch + '      <a href="" title="" target="_blank"><img src="images/qd_s' + counter + '.png" alt="" /></a>' + '\r\n'
                }
                html += perch + '    </div>' + '\r\n'
            } else {
                var split = "";
        ...
        $(".outer-section").each(function(i) {
            ...
            if (split.length > 0) {
                ...
                if (wrapper.find("li").length > 1) {
                    ...
                    css += '#outer-section-' + counter + ' .columns img {width: 100%; height: auto;}\r\n'
                }
            }
        });
